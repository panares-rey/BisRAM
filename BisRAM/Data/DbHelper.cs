    ...
    public class DbHelper
    {
        ...
        private void SeedData(SqliteConnection conn)
        {
            ...
            if (pc == 0)
            {
                ...
                {
                    ("Intel Core i9-14900K","24-core processor, up to 6.0GHz Turbo","CPU","Intel",29000m,15,"/images/products/CPU3.jpg"),
                    ("AMD Ryzen 9 7950X","16-core AM5 processor, 5nm Zen4","CPU","AMD",33150m,12,"/images/products/CPU1.jpg"),
                    ("Intel Core i5-13600K","14-core mid-range gaming CPU","CPU","Intel",17500m,30,"/images/products/CPU2.jpg"),
                    ("NVIDIA RTX 4090","24GB GDDR6X flagship GPU","GPU","NVIDIA",115000m,8,"/images/products/GPU3.jpg"),
                    ("NVIDIA RTX 4070 Ti","12GB GDDR6X high-performance GPU","GPU","NVIDIA",49500m,20,"/images/products/GPU2.jpg"),
                    ("AMD Radeon RX 7900 XTX","24GB GDDR6 flagship AMD GPU","GPU","AMD",59998m,10,"/images/products/GPU1.jpg"),
                    ("Corsair Vengeance DDR5 32GB","32GB DDR5-5600 CL36 RAM Kit","RAM","Corsair",8500m,50,"/images/products/RAM1.jpg"),
                    ("G.Skill Trident Z5 64GB","64GB DDR5-6400 RGB Memory Kit","RAM","G.Skill",50000m,25,"/images/products/RAM2.jpg"),
                    ("Samsung 990 Pro 2TB","PCIe 4.0 NVMe SSD 7450MB/s","Storage","Samsung",11000m,40,"/images/products/STORAGE1.jpg"),
                    ("WD Black SN850X 1TB","PCIe 4.0 NVMe gaming SSD","Storage","Western Digital",6000m,35,"/images/products/STORAGE3.jpg"),
                    ("Seagate BarraCuda 4TB","3.5in HDD 5400RPM storage","Storage","Seagate",6000m,60,"/images/products/STORAGE2.jpg"),
                    ("ASUS ROG Maximus Z790","Intel Z790 ATX flagship board","Motherboard","ASUS",36450m,10,"/images/products/MB1.jpg"),
                    ("MSI MAG B650 TOMAHAWK","AMD AM5 ATX gaming motherboard","Motherboard","MSI",14495m,20,"/images/products/MB3.jpg"),
                    ("Gigabyte B760M DS3H","Intel LGA1700 Micro-ATX board","Motherboard","Gigabyte",6495m,30,"/images/products/MB2.jpg"),
                    ("Corsair RM1000x","1000W 80+ Gold Fully Modular PSU","PSU","Corsair",10790m,20,"/images/products/PSU1.jpg"),
                    ("be quiet! Straight Power 850W","850W 80+ Platinum modular PSU","PSU","be quiet!",8200m,18,"/images/products/PSU2.jpg"),
                    ("NZXT H510 Flow","Mid-tower ATX mesh front panel","Case","NZXT",4395m,25,"/images/products/CASE2.jpg"),
                    ("Lian Li O11 Dynamic EVO","Premium dual-chamber ATX tower","Case","Lian Li",9460m,15,"/images/products/CASE1.jpg"),
                    ("Noctua NH-D15","Premium dual-tower CPU air cooler","Cooling","Noctua",6950m,30,"/images/products/COOLING2.jpg"),
                    ("ARCTIC Liquid Freezer III 360","360mm AIO liquid CPU cooler","Cooling","ARCTIC",5650m,22,"/images/products/COOLING1.jpg"),
                };
        ...
        public List<Listing> GetListings(string? q = null, string? cat = null, string? cond = null, string sort = "newest")
        {
            ...
            // Text search across Title, Description, Condition, and Category
            if (!string.IsNullOrEmpty(q)) { sql += " AND (Title LIKE @q OR Description LIKE @q OR Condition LIKE @q OR Category LIKE @q)"; cmd.Parameters.AddWithValue("@q", $"%{q}%"); }
